...
async function runWithoutInterrupts(func) {
    disableInterruptionEventListeners();

    await func();

    enableInterruptionEventListeners();
}
...
function addEventListenersForAlgoSelection() {
    ...
    algoSelectionMenu.forEach((menuItem) => {
        menuItem.addEventListener('click', handleUserAlgorithmSelection);
    });
}
...
function disableInterruptionEventListeners() {
    document.querySelector('#rand-array').style.pointerEvents = 'none';
    document.querySelector('#step-array').style.pointerEvents = 'none';
    document.querySelector('#shuffle').style.pointerEvents = 'none';
    document.querySelector('#run').style.pointerEvents = 'none';
}

function enableInterruptionEventListeners() {
    document.querySelector('#rand-array').style.pointerEvents = 'auto';
    document.querySelector('#step-array').style.pointerEvents = 'auto';
    document.querySelector('#shuffle').style.pointerEvents = 'auto';
    document.querySelector('#run').style.pointerEvents = 'auto';
}
...
function renderSwapInView(i, j) {
    ...
    containerDOM.children[i].setAttribute(
        'style',
        'height: ' + array[i] + 'px'
    );
    containerDOM.children[j].setAttribute(
        'style',
        'height: ' + array[j] + 'px'
    );
}
